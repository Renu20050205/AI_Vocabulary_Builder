...
checkQuiz.addEventListener("click", () => {
  ...
  const correctAns = quizBox.dataset.answer?.toLowerCase() || "";
  if (!correctAns) {
    quizResult.textContent = "No answer available for this quiz.";
  ...
  if (userAns === correctAns) {
    ...
    quizResult.textContent = `❌ Wrong! Correct answer: ${correctAns}`;
    quizResult.classList.add("text-red-600");
